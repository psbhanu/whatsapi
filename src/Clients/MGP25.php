<?php 
namespace psbhanu\Whatsapi\Clients;

use Closure;
use stdClass;
use Exception;
use WhatsProt;
use psbhanu\Whatsapi\Media\VCard;
use psbhanu\Whatsapi\MessageManager;
use psbhanu\Whatsapi\Events\Listener;
use psbhanu\Whatsapi\Sessions\SessionInterface;
use psbhanu\Whatsapi\Contracts\WhatsapiInterface;
...
class MGP25 implements WhatsapiInterface
{
     ...
     * Message manager
     * 
     * @var \psbhanu\Whatsapi\Whatsapi\MessageManager
     */
    protected $manager;
     ...
     * 
     * @var \psbhanu\Whatsapi\Events\Listener
     */
